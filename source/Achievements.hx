...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Operation: Safe Mode",		"Beat Dracobot's Week on Hard.",				'week1_beat',			false],
		["Field Guardian",				"Beat Olevadon's Week on Hard.",				'week2_beat',			false],
		["Bloody Massacre", 			"Beat Nacidio's Week on Hard.",				'week3_beat',			false],
		["Revenge", 				"Beat Spirit in a rematch and unlock a new difficulty!",				'dsnaps_beat',			false]
	];
