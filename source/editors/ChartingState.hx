...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Dracobot Shutter','If Value 0 is null or 0, it starts the Shutter,\nIf Value 0 is 1, it stops the Shutter.'],
		['Warning!','Warning effect from Error 404 but a charting event.'],
		['Arrow Effect','You cannot change this event.'],
