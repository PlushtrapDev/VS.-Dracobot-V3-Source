...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Bro what the fuck...', 0.2], //From 0% to 19%
	...
	var healthAmtDrain:Float;
	var healthDrain:Bool;
	...
	override public function create()
	{
		...
		if(PlayState.SONG.stage == null || PlayState.SONG.stage.length < 1) {
			switch (songName)
			{
				...
				case 'senpai' | 'roses':
					curStage = 'school';
				case 'thorns' | 'dragonsnaps' | 'dragon-horns':
					curStage = 'schoolEvil';
	...
	// I stole all of this from Hypno's Lullaby please Yoshubs don't yell at me ;-; - Plush
				...
				for (i in 0...playerStrums.length)
				{
					...
					if (reverseXY)
						playerStrums.members[i].setPosition(
							((FlxG.width / 3) - (playerStrums.members[i].width / 3)) + placementY, 
							((FlxG.height / 4) - (playerStrums.members[i].height / 4)) + placementX
						);
					else
						playerStrums.members[i].setPosition(
							((FlxG.width / 3) - (playerStrums.members[i].width / 3)) + placementX, 
							((FlxG.height / 4) - (playerStrums.members[i].height / 4)) + placementY
						);
				}
	}
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_beat', 'week2_beat', 'week3_beat', 'dsnaps_beat']);
	...
	private function checkForAchievement(achievesToCheck:Array<String>):String {
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				{
					case 'week1_beat' | 'week2_beat' | 'week3_beat':
						if(isStoryMode && CoolUtil.difficultyString() == 'HARD' && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							...
							{
								case 'weekd':
									if(achievementName == 'week1_beat') 
									unlock = true;
								case 'weeko':
									if(achievementName == 'week2_beat') 
									unlock = true;
								case 'weekn':
									if(achievementName == 'week3_beat') 
									unlock = true;
								case 'dragonsnaps':
									if(achievementName == 'dsnaps_beat') 
									unlock = true;
							}
						}
				}
